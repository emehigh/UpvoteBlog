...
const { createPost, showPost, showSinglePost, deletePost, updatePost, addComment, addUpvote, removeLike } = require('../controllers/postController');
...
router.put('/addupvote/post/:id', addUpvote);
